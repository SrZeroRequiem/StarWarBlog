                    ...
                    <Dropdown>
                        ...
                        <Dropdown.Menu className="menu">
                            ...
                            {store["favoritesFilms"].map((item, index) => {
                                return (
                                    <Link to={"/film/" + store.favoritesFilms[index].index} key={index}
                                          className="mb-1">
                            ...
                            {store["favoritesPlanets"].map((item, index) => {
                                return (
                                    <Link to={"/planet/" + store.favoritesPlanets[index].index} key={index}
                                          className="mb-1">
                                        <Dropdown.Item className="d-flex justify-content-between ">
                                            <p className="m-0">{item.title}</p>
                                            <i className="fas fa-circle-minus delete-button d-flex align-items-center"
                            ...
                            {store["favoritesCharacters"].map((item, index) => {
                                return (
                                    <Link to={"/character/" + store.favoritesCharacters[index].index} key={index}
                                          className="mb-1">
                                        <Dropdown.Item className="d-flex justify-content-between ">
                                            <p className="m-0">{item.title}</p>
                                            <i className="fas fa-circle-minus delete-button d-flex align-items-center"
                            ...
                            {store["favoritesStarships"].map((item, index) => {
                                return (
                                    <Link to={"/starship/" + store.favoritesStarships[index].index} key={index}
                                          className="mb-1">
                                        <Dropdown.Item className="d-flex justify-content-between ">
                                            <p className="m-0">{item.title}</p>
                                            <i className="fas fa-circle-minus delete-button d-flex align-items-center"
            ...
            <nav>
                <div className="row justify-content-start flex-row px-5">
                    <div className="col p-0">
                        ...
                        {/*<Link to="/starships/1" className="me-1 navHover float-end">
